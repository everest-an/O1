...
Generated: `2026-05-23T21:49:02.580157+00:00`
Device: `cpu`
PyTorch: `2.5.1+cu121`
...
|---:|---|---:|---:|---:|---:|---:|
| 100 | `full_sequence_oracle` | 5566.3 | 0 B | 0 B | 0 | 0 |
| 100 | `kv_cache_stream` | 294.2 | 106.4 KB | 106.4 KB | 6.6e-07 | 4.11e-06 |
| 100 | `state_only_stream` | 308.2 | 4.1 KB | 4.1 KB | 0.0887 | 0.453 |
| 100 | `prefix_replay_stream` | 104.4 | 0 B | 0 B | 3.67e-07 | 4.4e-06 |
| 1000 | `full_sequence_oracle` | 12227.4 | 0 B | 0 B | 0 | 0 |
| 1000 | `kv_cache_stream` | 275.5 | 1020.5 KB | 1020.5 KB | 5.45e-07 | 3.61e-06 |
| 1000 | `state_only_stream` | 296.7 | 4.1 KB | 4.1 KB | 0.0892 | 0.523 |
...
|---:|---:|---:|---:|---|
| 100 | 0.881 | 1.000 | 1.000 | s0_mean=0.881, s1_mean=0.881, s2_mean=0.881, s3_mean=0.881, s4_mean=0.881 |
| 1000 | 0.881 | 1.000 | 1.000 | s0_mean=0.881, s1_mean=0.881, s2_mean=0.881, s3_mean=0.881, s4_mean=0.881 |
